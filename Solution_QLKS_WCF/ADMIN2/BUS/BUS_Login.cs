...
namespace ADMIN2.BUS
{
    public class BUS_Login
    {
            ...
            if(tendangnhap.Trim().Length > 0 && matkhau.Trim().Length > 0)
            {
                ...
                else
                {
                    if(matkhau.Trim().Length > 7 && matkhau.Trim().Length < 21)
                    {
                        ...
                        {
                            if (Program.qlks.Login(tendangnhap.Trim(), matkhau.Trim(), 1))
                            {
        ...
        public void doimatkhau(TextBox mkcu, TextBox mkmoi, TextBox nhaplai)
        {
                ...
                else
                {
                    if (mkmoi.Text.Trim().Length > 7 && mkmoi.Text.Trim().Length < 21)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if (Program.qlks.kiemtramatkhaucu(frmSystem.user.Trim(), mkcu.Text.Trim()))
                                {
                                    Program.qlks.doimatkhau(frmSystem.user.Trim(), mkmoi.Text.Trim());
                                    mkcu.Text = "";
                                    mkmoi.Text = "";
                                    nhaplai.Text = "";
