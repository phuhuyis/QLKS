...
namespace Admin.GUI
{
    public partial class frm_thue_dat_phong : Form
    {
        ...
        uc_dat_kc datc = null;
        uc_dat_km datm = null;
        uc_thue_kc thuec = null;
        uc_thue_km thuem = null;
        Thread t1;
        TcpClient tcpclient;
        frmSystem frm;

        public frm_thue_dat_phong(String so, String c, frmSystem frm)
        {
            InitializeComponent();
            sophong = so;
            lk = c;
        ...
        private void btnthue_Click(object sender, EventArgs e)
        {
            ...
            BUS_thuedatphong.DAO.loadthue(datm, thuem, datc, thuec, lk, this, sophong, frm);
        }
        ...
        private void btndat_Click(object sender, EventArgs e)
        {
            ...
            BUS_thuedatphong.DAO.loaddat(datm, thuem, datc, thuec, lk, this, sophong, frm);
        }
        ...
        private void frm_thue_dat_phong_Load(object sender, EventArgs e)
        {
            ...
            t1 = new Thread(() =>
            {
                while (true)
                {
                    ...
                    {
                        if (content == "thuephongkm" + sophong)
                        {
                            Invoke(new Action(() =>
                            {
                                this.Close();
