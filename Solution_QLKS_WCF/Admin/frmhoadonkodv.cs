...
namespace Admin
{
    public partial class frmhoadonkodv : Form
    {
        String sohd;
        TcpClient tcpclient;
        Thread t1;
        ...
        public frmhoadonkodv(String sohd, frmSystem frm)
        {
            InitializeComponent();
            this.sohd = sohd;
            this.frm = frm;
        ...
        private void frmhoadonkodv_Load(object sender, EventArgs e)
        {
                        ...
                        else
                        {
                            if (content == "suakhachhang")
                            {
                                Invoke(new Action(() =>
                                {
                                    ...
                                    this.hoadonkodvBindingSource.DataSource = Program.qlks.inhdkodv(sohd);
        ...
        private void frmhoadonkodv_FormClosed(object sender, FormClosedEventArgs e)
        {
            t1.Abort();
        }
    }
