...
namespace Admin
{
    public partial class frmthongkeluong_thang : Form
    {
        TcpClient tcpclient;
        Thread t1;
        frmSystem frm;
        ...
        public frmthongkeluong_thang(frmSystem frm)
        {
            InitializeComponent();
            this.frm = frm;
        }

        private void frmthongkeluong_thang_Load(object sender, EventArgs e)
        {
                    ...
                    else
                    {
                        if (content == "nhapdichvu")
                        {
                            Invoke(new Action(() =>
                            {
                                if (kt)
                                {
                                    thongkeluongthangBindingSource.DataSource = Program.qlks.thongkeluong_thang(thang, nam);
        ...
        private void frmthongkeluong_thang_FormClosed(object sender, FormClosedEventArgs e)
        {
            t1.Abort();
        }
    }
