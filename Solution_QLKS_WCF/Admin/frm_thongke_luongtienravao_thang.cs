...
namespace Admin
{
    public partial class frm_thongke_luongtienravao_thang : Form
    {
        TcpClient tcpclient;
        Thread t1;
        frmSystem frm;
        ...
        public frm_thongke_luongtienravao_thang(frmSystem frm)
        {
            InitializeComponent();
            this.frm = frm;
        }

        private void frm_thongke_luongtienravao_thang_Load(object sender, EventArgs e)
        {
                    ...
                    else
                    {
                        if (content == "nhapdichvu")
                        {
                            Invoke(new Action(() =>
                            {
                                if (kt)
                                {
                                    thongketienravaothangBindingSource.DataSource = Program.qlks.thongketienravao_thang(thang, nam);
        ...
        private void frm_thongke_luongtienravao_thang_FormClosed(object sender, FormClosedEventArgs e)
        {
            t1.Abort();
        }
    }
