...
namespace Admin
{
    public partial class frmthongke_solanthue_nam : Form
    {
        TcpClient tcpclient;
        Thread t1;
        frmSystem frm;
        ...
        public frmthongke_solanthue_nam(frmSystem frm)
        {
            InitializeComponent();
            this.frm = frm;
        }

        private void frmthongke_solanthue_nam_Load(object sender, EventArgs e)
        {
                    ...
                    else
                    {
                        if (content == "nhapdichvu")
                        {
                            Invoke(new Action(() =>
                            {
                                if (kt)
                                {
                                    thongkesolanthuenamBindingSource.DataSource = Program.qlks.thongkesolanthue_nam(value);
        ...
        private void frmthongke_solanthue_nam_FormClosed(object sender, FormClosedEventArgs e)
        {
            t1.Abort();
        }
