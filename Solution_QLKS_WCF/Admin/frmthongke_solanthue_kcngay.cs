...
namespace Admin
{
    public partial class frmthongke_solanthue_kcngay : Form
    {
        TcpClient tcpclient;
        Thread t1;
        frmSystem frm;
        ...
        public frmthongke_solanthue_kcngay(frmSystem frm)
        {
            InitializeComponent();
            this.frm = frm;
        }

        private void frmthongke_solanthue_kcngay_Load(object sender, EventArgs e)
        {
                    ...
                    else
                    {
                        if (content == "nhapdichvu")
                        {
                            Invoke(new Action(() =>
                            {
                                if (kt)
                                {
                                    thongkesolanthuekcngayBindingSource.DataSource = Program.qlks.thongkesolanthue_kcngay(ngaybd, ngaykt);
        ...
        private void frmthongke_solanthue_kcngay_FormClosed(object sender, FormClosedEventArgs e)
        {
            t1.Abort();
        }
