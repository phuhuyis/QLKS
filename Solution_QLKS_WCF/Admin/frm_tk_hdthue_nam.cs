...
namespace Admin
{
    public partial class frm_tk_hdthue_nam : Form
    {
        int nam;
        frmSystem frm;
        TcpClient tcpclient;
        ...
        public frm_tk_hdthue_nam(frmSystem frm)
        {
            InitializeComponent();
            this.frm = frm;
        }
        ...
        private void btntable_Click(object sender, EventArgs e)
        {
            ...
            BUS_tkhdthue.DAO.tknam(dgv, nam);
        }

        private void frm_tk_hdthue_nam_Load(object sender, EventArgs e)
        {
        ...
        private void frm_tk_hdthue_nam_FormClosed(object sender, FormClosedEventArgs e)
        {
            t1.Abort();
        }
