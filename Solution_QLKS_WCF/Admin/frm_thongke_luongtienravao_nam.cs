...
namespace Admin
{
    public partial class frm_thongke_luongtienravao_nam : Form
    {
        TcpClient tcpclient;
        Thread t1;
        frmSystem frm;
        ...
        public frm_thongke_luongtienravao_nam(frmSystem frm)
        {
            InitializeComponent();
            this.frm = frm;
        }

        private void frm_thongke_luongtienravao_nam_Load(object sender, EventArgs e)
        {
                    ...
                    else
                    {
                        if (content == "nhapdichvu")
                        {
                            Invoke(new Action(() =>
                            {
                                if (kt)
                                {
                                    thongketienravaonamBindingSource.DataSource = Program.qlks.thongketienravao_nam(value);
        ...
        private void frm_thongke_luongtienravao_nam_FormClosed(object sender, FormClosedEventArgs e)
        {
            t1.Abort();
        }
    }
