...
namespace Admin
{
    public partial class frm_tk_hdthue_kcngay : Form
    {
        ...
        public frm_tk_hdthue_kcngay(frmSystem frm)
        {
            InitializeComponent();
            this.frm = frm;
        }

        private void frm_tk_hdthue_kcngay_Load(object sender, EventArgs e)
        {
                    ...
                    else
                    {
                        if (content == "nhapdichvu")
                        {
                            Invoke(new Action(() =>
                            {
                                if (kt)
                                {
                                    BUS_tkhdthue.DAO.tkkcngay(dgv, ngaybd, ngaykt);
                                }
                            }));
                        }
                        else
        ...
        private void frm_tk_hdthue_kcngay_FormClosed(object sender, FormClosedEventArgs e)
        {
            t1.Abort();
        }
